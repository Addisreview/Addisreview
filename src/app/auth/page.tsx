  ...
  return (
    <>
      ...
      <div style={{ minHeight: 'calc(100vh - 64px)', display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
        ...
        {/* ── RIGHT PANEL ── */}
        <div style={{ padding: '60px', display: 'flex', flexDirection: 'column', justifyContent: 'center', background: 'var(--warm-white)' }}>
          <div style={{ maxWidth: '380px', width: '100%' }}>
            ...
            {tab === 'signup' && (
              <>
                ...
                <button
                  ...
                  disabled={loading}
                  style={{ width: '100%', padding: '14px', background: 'var(--green)', color: '#fff', border: 'none', borderRadius: '10px', fontFamily: 'var(--font-sans)', fontWeight: 700, fontSize: '.95rem', cursor: 'pointer', transition: 'background .2s' }}
                >
            ...
            {tab === 'login' && (
              <>
                ...
                <div style={{ textAlign: 'center', fontSize: '.8rem', color: 'var(--muted)', marginTop: '20px' }}>
                  <span style={{ color: 'var(--green)', fontWeight: 600, cursor: 'pointer' }}>Forgot your password?</span>
                </div>
              </>
            )}
          </div>
